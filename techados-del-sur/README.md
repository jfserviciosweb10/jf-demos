# Techados del Sur — Checklist post-entrega
...
git init
git add .
git commit -m "Sitio Techados del Sur — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/techados-del-sur.git
