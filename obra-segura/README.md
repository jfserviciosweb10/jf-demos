# Obra Segura Construcciones — Checklist post-entrega
...
git init
git add .
git commit -m "Sitio Obra Segura Construcciones — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/obra-segura.git
