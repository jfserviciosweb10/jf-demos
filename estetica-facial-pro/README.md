# Estética Facial Pro — Checklist post-entrega

## Datos del cliente
- **Dominio:** esteticafacialpro.com.ar
- **Ciudad:** Rosario, Santa Fe
- **WhatsApp:** 5493415555015
- **Email:** info@esteticafacialpro.com.ar
...
git init
git add .
git commit -m "Sitio Estética Facial Pro — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/estetica-facial-pro.git
