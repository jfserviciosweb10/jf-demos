# Spa Relax Total — Checklist post-entrega
...
git init
git add .
git commit -m "Sitio Spa Relax Total — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/spa-relax-total.git
