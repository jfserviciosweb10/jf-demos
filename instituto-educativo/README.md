# Instituto Educativo San Martín — Checklist post-entrega
...
git init
git add .
git commit -m "Sitio Instituto Educativo San Martín — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/instituto-educativo.git
