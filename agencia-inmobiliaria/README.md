# Inmobiliaria Del Centro — Checklist post-entrega

## Datos del cliente
- **Dominio:** inmobiliariadelcentro.com.ar
- **Ciudad:** Santa Fe, Santa Fe
- **WhatsApp:** 5493425553003
- **Email:** info@inmobiliariadelcentro.com.ar
...
git init
git add .
git commit -m "Sitio Inmobiliaria Del Centro — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/agencia-inmobiliaria.git
