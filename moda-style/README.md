# Moda Style Boutique — Checklist post-entrega

## Datos del cliente
- **Dominio:** modastyleMza.com.ar
- **Ciudad:** Mendoza, Mendoza
- **WhatsApp:** 5492615557027
- **Email:** info@modastyleMza.com.ar
...
git init
git add .
git commit -m "Sitio Moda Style Boutique — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/moda-style.git
