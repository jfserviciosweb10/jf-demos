# Peluquería Mónica — Checklist post-entrega

## Datos del cliente
- **Dominio:** peluqueriamonica.com.ar
- **Ciudad:** Paraná, Entre Ríos
- **WhatsApp:** 5493435556052
- **Email:** info@peluqueriamonica.com.ar
...
git init
git add .
git commit -m "Sitio Peluquería Mónica — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/peluqueria-monica.git
