# Lex & Partners — Checklist post-entrega

## Datos del cliente
- **Dominio:** lexpartnersba.com.ar
- **Ciudad:** Buenos Aires, CABA
- **WhatsApp:** 5491155550050
- **Email:** consultas@lexpartners.com.ar
...
git init
git add .
git commit -m "Sitio Lex & Partners — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/estudio-juridico.git
