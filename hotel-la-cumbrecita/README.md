# Hotel Serrano La Cumbrecita — Checklist post-entrega
...
git init
git add .
git commit -m "Sitio Hotel Serrano La Cumbrecita — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/hotel-la-cumbrecita.git
