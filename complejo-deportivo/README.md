# Complejo Deportivo Arena — Checklist post-entrega

## Datos del cliente
- **Dominio:** complejoarenamdp.com.ar
- **Ciudad:** Mar del Plata, Buenos Aires
- **WhatsApp:** 5492235559009
- **Email:** info@complejoarenamdp.com.ar
...
git init
git add .
git commit -m "Sitio Complejo Deportivo Arena — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/complejo-deportivo.git
