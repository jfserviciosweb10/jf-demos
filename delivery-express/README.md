# Delivery Express 24hs — Checklist post-entrega

## Datos del cliente
- **Dominio:** deliveryexpress24.com.ar
- **Ciudad:** Buenos Aires, CABA
- **WhatsApp:** 5491155522012
- **Email:** info@deliveryexpress24.com.ar
...
git init
git add .
git commit -m "Sitio Delivery Express 24hs — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/delivery-express.git
