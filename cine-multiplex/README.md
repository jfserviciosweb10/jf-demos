# Cine Multiplex Estrella — Checklist post-entrega
...
git init
git add .
git commit -m "Sitio Cine Multiplex Estrella — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/cine-multiplex.git
