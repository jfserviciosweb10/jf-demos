# Mueblería Moderna — Checklist post-entrega

## Datos del cliente
- **Dominio:** muebleriamodernaba.com.ar
- **Ciudad:** Buenos Aires, CABA
- **WhatsApp:** 5491155558028
- **Email:** info@muebleriamodernaba.com.ar
...
git init
git add .
git commit -m "Sitio Mueblería Moderna — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/muebleria-moderna.git
