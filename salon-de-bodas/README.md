# Salón de Bodas El Jardín — Checklist post-entrega

## Datos del cliente
- **Dominio:** saloneljardinCba.com.ar
- **Ciudad:** Córdoba, Córdoba
- **WhatsApp:** 5493515557037
- **Email:** info@saloneljardinCba.com.ar
...
git init
git add .
git commit -m "Sitio Salón de Bodas El Jardín — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/salon-de-bodas.git
