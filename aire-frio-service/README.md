# AireFrío Service — Checklist post-entrega

## Datos del cliente
- **Dominio:** airfrioservice.com.ar
...
git init
git add .
git commit -m "Sitio AireFrío Service — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/aire-frio-service.git
