# Hotel Las Sierras — Checklist post-entrega

## Datos del cliente
- **Dominio:** hotellassierrasvgb.com.ar
- **Ciudad:** Villa General Belgrano, Córdoba
- **WhatsApp:** 5493546552022
- **Email:** info@hotellassierrasvgb.com.ar
...
git init
git add .
git commit -m "Sitio Hotel Las Sierras — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/hotel-las-sierras.git
