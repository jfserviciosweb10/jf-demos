# Lavadero de Autos Premium — Checklist post-entrega
...
git init
git add .
git commit -m "Sitio Lavadero de Autos Premium — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/lavadero-de-autos.git
