# Viajes del Sol — Checklist post-entrega

## Datos del cliente
- **Dominio:** viajesdelsolmza.com.ar
- **Ciudad:** Mendoza, Mendoza
- **WhatsApp:** 5492615552002
- **Email:** info@viajesdelsolmza.com.ar
...
git init
git add .
git commit -m "Sitio Viajes del Sol — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/agencia-de-viajes.git
