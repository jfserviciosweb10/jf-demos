# Pinturería Color Total — Checklist post-entrega

## Datos del cliente
- **Dominio:** pintureriacolortotal.com.ar
- **Ciudad:** Mendoza, Mendoza
- **WhatsApp:** 5492615553033
- **Email:** info@pintureriacolortotal.com.ar
...
git init
git add .
git commit -m "Sitio Pinturería Color Total — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/pintureria-color.git
