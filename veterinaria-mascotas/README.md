# Veterinaria Mascotas Felices — Checklist post-entrega

## Datos del cliente
- **Dominio:** veterinariamascoTasMza.com.ar
- **Ciudad:** Mendoza, Mendoza
- **WhatsApp:** 5492615552042
- **Email:** info@veterinariamascoTasMza.com.ar
...
git init
git add .
git commit -m "Sitio Veterinaria Mascotas Felices — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/veterinaria-mascotas.git
