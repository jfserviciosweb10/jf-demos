# BarberKing — Checklist post-entrega

## Datos del cliente
- **Dominio:** barberkingba.com.ar
- **Ciudad:** Buenos Aires, CABA
- **WhatsApp:** 5491155550045
- **Email:** turnos@barberking.com.ar
...
git init
git add .
git commit -m "Sitio BarberKing — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/barberia.git
