# Foto Studio Lens — Checklist post-entrega

## Datos del cliente
- **Dominio:** fotostudiolens.com.ar
- **Ciudad:** Córdoba, Córdoba
- **WhatsApp:** 5493515559019
- **Email:** info@fotostudiolens.com.ar
...
git init
git add .
git commit -m "Sitio Foto Studio Lens — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/foto-studio.git
