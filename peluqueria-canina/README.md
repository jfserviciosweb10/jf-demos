# Peluquería Canina Happy Dog — Checklist post-entrega
...
git init
git add .
git commit -m "Sitio Peluquería Canina Happy Dog — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/peluqueria-canina.git
