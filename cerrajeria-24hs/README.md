# Cerrajería 24hs Rápida — Checklist post-entrega
...
git init
git add .
git commit -m "Sitio Cerrajería 24hs Rápida — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/cerrajeria-24hs.git
