# Carpintería Don Marcos — Checklist post-entrega
...
git init
git add .
git commit -m "Sitio Carpintería Don Marcos — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/carpinteria-artesanal.git
