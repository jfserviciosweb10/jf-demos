# Odontología Gómez — Checklist post-entrega
...
git init
git add .
git commit -m "Sitio Odontología Gómez — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/odontologia-gomez.git
