# Taxi Ejecutivo Premium — Checklist post-entrega

## Datos del cliente
- **Dominio:** taxiEjecutivopremium.com.ar
- **Ciudad:** Buenos Aires, CABA
- **WhatsApp:** 5491155550040
- **Email:** info@taxiEjecutivopremium.com.ar
...
git init
git add .
git commit -m "Sitio Taxi Ejecutivo Premium — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/taxi-ejecutivo.git
