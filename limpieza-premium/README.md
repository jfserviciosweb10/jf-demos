# Limpieza Premium — Checklist post-entrega

## Datos del cliente
- **Dominio:** limpiezapremiumba.com.ar
- **Ciudad:** Buenos Aires, CABA
- **WhatsApp:** 5491155555025
- **Email:** info@limpiezapremiumba.com.ar
...
git init
git add .
git commit -m "Sitio Limpieza Premium — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/limpieza-premium.git
