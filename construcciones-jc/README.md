# Construcciones JC — Checklist post-entrega

## Datos del cliente
- **Dominio:** construccionesjcrosario.com.ar
- **Ciudad:** Rosario, Santa Fe
- **WhatsApp:** 5493415550010
- **Email:** info@construccionesjcrosario.com.ar
...
git init
git add .
git commit -m "Sitio Construcciones JC — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/construcciones-jc.git
