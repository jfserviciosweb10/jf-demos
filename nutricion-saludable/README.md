# Nutrición Saludable Lic. Gómez — Checklist post-entrega

## Datos del cliente
- **Dominio:** nutriciongomez.com.ar
- **Ciudad:** Rosario, Santa Fe
- **WhatsApp:** 5493415559029
- **Email:** info@nutriciongomez.com.ar
...
git init
git add .
git commit -m "Sitio Nutrición Saludable Lic. Gómez — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/nutricion-saludable.git
