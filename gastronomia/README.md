# El Fogón — Checklist post-entrega

## Datos del cliente
- **Dominio:** elfogonresto.com.ar
- **Ciudad:** Buenos Aires, CABA
- **WhatsApp:** 5491155550043
- **Email:** reservas@elfogon.com.ar
...
git init
git add .
git commit -m "Sitio El Fogón — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/gastronomia.git
