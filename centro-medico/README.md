# MediCentro — Checklist post-entrega

## Datos del cliente
- **Dominio:** medicentroba.com.ar
- **Ciudad:** Buenos Aires, CABA
- **WhatsApp:** 5491155550051
- **Email:** turnos@medicentro.com.ar
...
git init
git add .
git commit -m "Sitio MediCentro — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/centro-medico.git
