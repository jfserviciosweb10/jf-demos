# TallerPro — Checklist post-entrega

## Datos del cliente
- **Dominio:** tallerprocba.com.ar
- **Ciudad:** Buenos Aires, CABA
- **WhatsApp:** 5491155550046
- **Email:** info@tallerpro.com.ar
...
git init
git add .
git commit -m "Sitio TallerPro — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/mecanica-automotriz.git
