# Centro Cultural La Nave — Checklist post-entrega

## Datos del cliente
- **Dominio:** centrolanaveba.com.ar
- **Ciudad:** Buenos Aires, CABA
- **WhatsApp:** 5491155566006
- **Email:** info@centrolanaveba.com.ar
...
git init
git add .
git commit -m "Sitio Centro Cultural La Nave — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/centro-cultural.git
