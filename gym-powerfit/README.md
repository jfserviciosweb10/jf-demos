# Gym PowerFit — Checklist post-entrega

## Datos del cliente
- **Dominio:** gympowerfit.com.ar
- **Ciudad:** Buenos Aires, CABA
- **WhatsApp:** 5491155511021
- **Email:** info@gympowerfit.com.ar
...
git init
git add .
git commit -m "Sitio Gym PowerFit — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/gym-powerfit.git
