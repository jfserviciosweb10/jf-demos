# Ferretería El Clavo — Checklist post-entrega

## Datos del cliente
- **Dominio:** ferreteriaelclavo.com.ar
- **Ciudad:** Rafaela, Santa Fe
- **WhatsApp:** 5493492557017
- **Email:** info@ferreteriaelclavo.com.ar
...
git init
git add .
git commit -m "Sitio Ferretería El Clavo — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/ferreteria-el-clavo.git
