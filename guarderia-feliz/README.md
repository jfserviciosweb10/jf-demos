# Guardería Feliz — Checklist post-entrega
...
git init
git add .
git commit -m "Sitio Guardería Feliz — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/guarderia-feliz.git
