# La Leña — Checklist post-entrega

## Datos del cliente
- **Dominio:** lalenapizzas.com.ar
- **Ciudad:** Buenos Aires, CABA
- **WhatsApp:** 5491155550044
- **Email:** pedidos@lalena.com.ar
...
git init
git add .
git commit -m "Sitio La Leña — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/pizzeria.git
