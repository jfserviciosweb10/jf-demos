# FlexFlete — Checklist post-entrega

## Datos del cliente
- **Dominio:** flexfleteba.com.ar
- **Ciudad:** Buenos Aires, CABA
- **WhatsApp:** 5491155550048
- **Email:** info@flexflete.com.ar
...
git init
git add .
git commit -m "Sitio FlexFlete — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/fletes-mudanzas.git
