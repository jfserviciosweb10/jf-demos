# Cosméticos Naturales Pura Vida — Checklist post-entrega

## Datos del cliente
- **Dominio:** puravidacosmeticos.com.ar
- **Ciudad:** Mendoza, Mendoza
- **WhatsApp:** 5493496591636
- **Email:** info@puravidacosmeticos.com.ar
...
git init
git add .
git commit -m "Sitio Cosméticos Naturales Pura Vida — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/cosmeticos-naturales.git
