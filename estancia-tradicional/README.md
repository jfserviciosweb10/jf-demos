# Estancia La Pampa Grande — Checklist post-entrega
...
git init
git add .
git commit -m "Sitio Estancia La Pampa Grande — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/estancia-tradicional.git
