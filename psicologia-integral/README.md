# Psicología Integral — Checklist post-entrega

## Datos del cliente
- **Dominio:** psicologiaintegralba.com.ar
- **Ciudad:** Buenos Aires, CABA
- **WhatsApp:** 5491155556036
- **Email:** info@psicologiaintegralba.com.ar
...
git init
git add .
git commit -m "Sitio Psicología Integral — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/psicologia-integral.git
