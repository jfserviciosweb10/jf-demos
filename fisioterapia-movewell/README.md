# Fisioterapia MoveWell — Checklist post-entrega

## Datos del cliente
- **Dominio:** movewellmza.com.ar
- **Ciudad:** Mendoza, Mendoza
- **WhatsApp:** 5492615558018
- **Email:** info@movewellmza.com.ar
...
git init
git add .
git commit -m "Sitio Fisioterapia MoveWell — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/fisioterapia-movewell.git
