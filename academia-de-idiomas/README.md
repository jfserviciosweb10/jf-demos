# Academia de Idiomas Lingua — Checklist post-entrega

## Datos del cliente
- **Dominio:** linguacba.com.ar
- **Ciudad:** Córdoba, Córdoba
- **WhatsApp:** 5493515551001
- **Email:** info@linguacba.com.ar
...
git init
git add .
git commit -m "Sitio Academia de Idiomas Lingua — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/academia-de-idiomas.git
