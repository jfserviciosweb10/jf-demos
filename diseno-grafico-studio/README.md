# Estudio Gráfico Forma — Checklist post-entrega

## Datos del cliente
- **Dominio:** estudioformacba.com.ar
- **Ciudad:** Córdoba, Córdoba
- **WhatsApp:** 5493515553013
- **Email:** info@estudioformacba.com.ar
...
git init
git add .
git commit -m "Sitio Estudio Gráfico Forma — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/diseno-grafico-studio.git
