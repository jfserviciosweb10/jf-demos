# Pisos y Revestimientos Élite — Checklist post-entrega

## Datos del cliente
- **Dominio:** pisosyelite.com.ar
- **Ciudad:** Rosario, Santa Fe
- **WhatsApp:** 5493415554034
...
git init
git add .
git commit -m "Sitio Pisos y Revestimientos Élite — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/pisos-y-revestimientos.git
