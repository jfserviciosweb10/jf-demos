# Maquilladora Pro Studio — Checklist post-entrega

## Datos del cliente
- **Dominio:** maquilladoraprostudio.com.ar
- **Ciudad:** Córdoba, Córdoba
- **WhatsApp:** 5493515556026
- **Email:** info@maquilladoraprostudio.com.ar
...
git init
git add .
git commit -m "Sitio Maquilladora Pro Studio — JF Servicios Web"
git branch -M main
git remote add origin https://github.com/[usuario]/maquilladora-pro.git
